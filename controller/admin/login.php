...
<html>
    ...
    <body>
        <div class ="login">
            ...
            <p class="text-center">Created By - <a href="www.tarannaumsultan">Tarannaum Jahan Sultan</a></p>
        </div>
    </body>
</html>
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        //2.sql to check if the user with username and pass exists or not
        ...
        if($count==1){
            ...
            header('location:'.SITEURL.'controller/admin/');
        }
        else{
            //user npt available and login failed
